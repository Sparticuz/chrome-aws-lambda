...
%.zip:
	...
	mkdir -p nodejs
	npm install --prefix nodejs/ tar-fs@2.1.1 puppeteer-core@16.2.0 --bin-links=false --fund=false --omit=optional --omit=dev --package-lock=false --save=false
	npm pack
	...
	npx clean-modules --directory nodejs --yes
	npm run minify
